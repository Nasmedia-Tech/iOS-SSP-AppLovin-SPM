...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-AppLovin-SPM/releases/download/1.0.6/AdMixerMediationAppLovin1.0.6.xcframework.zip",
            checksum: "dd5d9827dbedb751b88551dc0eb3b26b28b7eb649d362f73d6a191e6d64c058d"
        )
    ]
)
