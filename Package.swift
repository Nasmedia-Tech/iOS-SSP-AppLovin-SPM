...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-AppLovin-SPM/releases/download/1.1.0/AdMixerMediationAppLovin1.1.0.xcframework.zip",
            checksum: "77d9254a331d02bee3427d0129ca7fd15a5cddfcc8d2500f0de72110d8b15376"
        )
    ]
)
